...
def build_tool_group_summary(tool_calls: List[Dict[str, Any]]) -> Tuple[List[str], Optional[str]]:
    """
    ...
    summary_parts = []
    for key, label in [('terminal', 'terminal'), ('file-write', 'write'), 
                       ('file-read', 'read'), ('plan', 'plan')]:
